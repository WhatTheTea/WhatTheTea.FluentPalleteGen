...
namespace WhatTheTea.FluentPalleteGen.Internal
{
    public static class ColorUtils
    {
        ...
        public static string FormatColorString(ARGB input, ColorStringFormat format, int precision = 4)
        {
            switch (format)
            {
        ...
        public static bool TryParseColorString(string input, out ARGB retVal)
        {
            if (input.StartsWith("#"))
            {
                uint raw;
                if (uint.TryParse(input.Substring(1), System.Globalization.NumberStyles.HexNumber, System.Globalization.CultureInfo.InvariantCulture, out raw))
                {
                    if (input.Length == 7)
                    {
                        raw |= 0xFF000000;
            ...
            else
            {
                ...
                // TODO: implement known colors support
                /* switch (inputLower)
                {
                    case "aliceblue":
        ...
        public static HSL RGBToHSL(ARGB rgb, bool round = true, int roundingPrecision = DefaultRoundingPrecision) =>
            RGBToHSL(new NormalizedRGB(rgb, false), round, roundingPrecision);
        ...
        // This ignores the Alpha channel of the input color
        public static HSV RGBToHSV(ARGB rgb, bool round = true, int roundingPrecision = DefaultRoundingPrecision)
        {
        ...
        // This ignores the Alpha channel of the input color
        public static XYZ RGBToXYZ(ARGB rgb, bool round = true, int roundingPrecision = DefaultRoundingPrecision)
        {
        ...
        // This ignores the Alpha channel of the input color
        public static LAB RGBToLAB(ARGB rgb, bool round = true, int roundingPrecision = DefaultRoundingPrecision)
        {
        ...
        // This ignores the Alpha channel of the input color
        public static LCH RGBToLCH(ARGB rgb, bool round = true, int roundingPrecision = DefaultRoundingPrecision)
        {
        ...
        // This ignores the Alpha channel of the input color
        public static double RGBToTemperature(ARGB rgb, bool round = true, int roundingPrecision = DefaultRoundingPrecision)
        {
        ...
        // This ignores the Alpha channel of the input color
        public static double RGBToLuminance(ARGB rgb, bool round = true, int roundingPrecision = DefaultRoundingPrecision)
        {
        ...
        public static double ContrastRatio(ARGB a, ARGB b, bool round = true, int roundingPrecision = DefaultRoundingPrecision)
        {
        ...
        public static ARGB ChooseColorForContrast(IEnumerable<ARGB> colorOptions, ARGB background)
        {
            if (colorOptions == null)
            {
                throw new ArgumentNullException("colorOptions");
            }
            ARGB bestColor = default;
            double bestRatio = 0;
        ...
        public static ARGB InterpolateRGB(ARGB left, ARGB right, double position)
        {
            if (position <= 0)
            {
                return left;
            ...
            return ARGB.FromArgb(MathUtils.Lerp(left.A, right.A, position), MathUtils.Lerp(left.R, right.R, position), MathUtils.Lerp(left.G, right.G, position), MathUtils.Lerp(left.B, right.B, position));
        }
